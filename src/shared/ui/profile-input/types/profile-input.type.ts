export type TProfileInput = 'error' | 'profile';
...
export const VALIDATION_RULES: IValidationRules = {
  ...
  login: {
    ...
    message: 'Логин должен содержать от 3 до 20 символов, буквы, цифры, дефис и подчеркивание',
  },
  password: {
    pattern: /^(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{8,40}$/,
    message: 'Пароль должен содержать от 8 до 40 символов, хотя бы одну заглавную букву и цифру',
  },
  first_name: {
